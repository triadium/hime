...
export class ASTNode implements SemanticElement {
  ...
  get Parent(): ASTNode | null {
    return this.tree.FindParentOf(this.index)
  }

  /// <summary>
  /// Gets the type of symbol this element represents
  /// </summary>
  get SymbolType(): GSymbolType {
    return this.tree.GetSymbolType(this.index)!
  }

  /// <summary>
  /// Gets the children of this node
  /// </summary>
  get Children(): ASTFamily {
    return new ASTFamily(this.tree, this.index)
  }
  ...
  get Position(): TextPosition {
    return this.tree.GetPosition(this.index)
  }
  ...
  /// </summary>
  get Span(): TextSpan {
    return this.tree.GetSpan(this.index)
  }
  ...
  get Context(): TextContext {
    return this.tree.GetContext(this.index)
  }
  ...
  /// </summary>
  get Symbol(): GSymbol {
    return this.tree.GetSymbol(this.index)
  }
  ...
  /// </summary>
  get Value(): string {
    return this.tree.GetValue(this.index) ?? '' /* null */
  }
