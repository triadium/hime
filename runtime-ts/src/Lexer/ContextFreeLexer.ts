 ...
 ******************************************************************************/
/// <reference path="./Automaton.ts" />
/// <reference path="./BaseLexer.ts" />
/// <reference path="./FuzzyMatcher.ts" />
/// <reference path="./PrefetchedText.ts" />
/// <reference path="./ContextSensitiveLexer.ts" />
