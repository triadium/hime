 ...
 ******************************************************************************/
import { byte, int, long, short, ubyte, uint, ulong, ushort } from "./BaseTypes"
...
export class BinaryReader {
    static Create(buffer: string | Buffer, encoding: BufferEncoding = 'binary', endianness: 'little' | 'big' = 'little'): IBinaryReader {
        switch (endianness) {
