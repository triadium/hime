...
export class Token implements SemanticElement {
  ...
  get Position(): TextPosition {
    return this.repository.GetPosition(this.index)
  }
  ...
  /// </summary>
  get Span(): TextSpan {
    return this.repository.GetSpan(this.index)
  }
  ...
  get Context(): TextContext {
    return this.repository.GetContext(this.index)
  }
  ...
  /// </summary>
  get Symbol(): GSymbol {
    return this.repository.GetSymbol(this.index)
  }
  ...
  /// </summary>
  get Value(): string {
    return this.repository.GetValue(this.index)
  }
