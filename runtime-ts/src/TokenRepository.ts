...
namespace Hime.Redist {
	...
	export class TokenRepository implements Iterable<Token> {
		...
		/// </summary>
		private readonly cells: Utils.BigList<TokenRepositoryNested.Cell>

		/// <summary>
		/// Gets the number of tokens in this repository
		/// </summary>
		get Size(): int { return this.cells.Size }
		...
		Add(terminal: int, index: int, length: int): int {
			return this.cells.Add(new TokenRepositoryNested.Cell(terminal, new TextSpan(index, length)))
		}
	}

	namespace TokenRepositoryNested {
		/// <summary>
		...
		/// </summary>
		export class LinearEnumerator implements Iterable<Token> {
			/// <summary>
			/// The repository
			/// </summary>
