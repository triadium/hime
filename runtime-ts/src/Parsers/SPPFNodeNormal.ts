...
export class SPPFNodeNormal extends SPPFNode {
	...
	/// </summary>
	get IsReplaceable(): boolean { return false }

	/// <summary>
	/// Gets the original symbol for this node
	/// </summary>
	get OriginalSymbol(): TableElemRef { return this.original }

	/// <summary>
	/// Gets the default version of this node
	/// </summary>
	get DefaultVersion(): SPPFNodeVersion { return this.versions[0]! }
	...
	constructor(identifier: int, original: TableElemRef, label: TableElemRef | null = null, childrenBuffer: SPPFNodeRef[] | null = null, childrenCount: int = 0) {
		super(identifier)
