...
export class SPPFNodeReplaceable extends SPPFNode {
	...
	/// </summary>
	get IsReplaceable(): boolean { return true }

	/// <summary>
	/// Gets the original symbol for this node
	/// </summary>
	get OriginalSymbol(): TableElemRef { return this.label }
	...
	/// </summary>
	get Actions(): TreeAction[] | null { return this.actions }
	...
	constructor(identifier: int, label: TableElemRef, childrenBuffer: SPPFNodeRef[], actionsBuffer: TreeAction[], childrenCount: int) {
		super(identifier)
