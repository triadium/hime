...
export abstract class LRkParser extends BaseLRParser implements IContextProvider {
  ...
  GetContextPriority(context: int, onTerminalID: int): int {
    ...
    return action.Code === LRActionCode.Shift &&
