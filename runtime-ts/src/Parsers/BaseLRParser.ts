...
export abstract class BaseLRParser {
  ...
  /// </summary>
  get SymbolVariables(): ROList<GSymbol> {
    return this.symVariables
  }

  /// <summary>
  /// Gets the virtual symbols used by this parser
  /// </summary>
  get SymbolVirtuals(): ROList<GSymbol> {
    return this.symVirtuals
  }

  /// <summary>
  /// Gets the action symbols used by this parser
  /// </summary>
  get SymbolActions(): ROList<SemanticAction> {
    return this.symActions
  }
