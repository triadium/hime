...
export class UnexpectedTokenError extends ParseError {
	...
	/// </summary>
	get Type(): ParseErrorType { return ParseErrorType.UnexpectedToken }

	/// <summary>
	/// Gets the error's length in the input (in number of characters)
	/// </summary>
	get Length(): int { return this.unexpected.Span.Length }
	...
	/// </summary>
	get UnexpectedToken(): Token { return this.unexpected }

	/// <summary>
	/// Gets the expected terminals
	/// </summary>
	get ExpectedTerminals(): ROList<GSymbol> { return this.expected }
